import { MainCalender } from "@/components/MainCalendar";
      ...
      <section className="flex flex-col xl:flex-row gap-6 w-full">
        <Card className="xl:w-[60%]">
          <div className="flex justify-between mb-6">
            <p className="text-lg pl-2 font-semibold">Sales trend</p>
            <div className="flex gap-2 items-center">
              <p className="hidden md:block">Sort by:</p>
              <DropdownMenu>
                <DropdownMenuTrigger className="border rounded-full flex gap-3 px-4 py-2"><p>Weekly</p> <ChevronDown /></DropdownMenuTrigger>
        ...
        <div className="xl:w-[40%] grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="rounded-lg p-6 w-full">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <Progress4 className="w-full rounded-full h-2.5" value={20} />
                <div className="flex items-center justify-between mt-1 text-lg">
                  <p className="text-muted-foreground">$1,600,000</p>
                  <span className="text-lg font-medium text-muted-foreground">+15%</span>
                </div>
              </div>
            </div>
